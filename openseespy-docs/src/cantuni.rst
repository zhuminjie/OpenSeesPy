...
#. The source code is shown below, which can be downloaded :download:`here </pyExamples/EarthquakeExamples/Example3/Example3.py>`.



.. literalinclude:: /pyExamples/EarthquakeExamples/Example3/Example3.py
   :linenos:
