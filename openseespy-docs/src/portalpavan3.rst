...
#. To run EQ ground-motion analysis (:download:`ReadRecord.py </pyExamples/EarthquakeExamples/Example4/ReadRecord.py>`, :download:`H-E12140.DT2</pyExamples/EarthquakeExamples/Example4/H-E12140.DT2>` needs to be downloaded into the same directory)
...
#. The source code is shown below, which can be downloaded :download:`here </pyExamples/EarthquakeExamples/Example4/Example4c.py>`.



.. literalinclude:: /pyExamples/EarthquakeExamples/Example4/Example4c.py
   :linenos:
