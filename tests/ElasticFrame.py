...
node1Rxn = nodeReaction( 1) # nodeReaction command returns nodal reactions for specified node in a list
node2Rxn =nodeReaction( 2)
node3Rxn =nodeReaction( 3)
node4Rxn =nodeReaction( 4)
...
if abs(T1-1.0401120938612862)<1e-12 and abs(T2-0.3526488583606463)<1e-12 and abs(T3-0.1930409642350476)<1e-12 and abs(T4-0.15628823050715784)<1e-12 and abs(T5-0.13080166151268388)<1e-12:
    print("Passed!")
else :
    print("Failed!")
