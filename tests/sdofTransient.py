...
# add load pattern
timeSeries('Trig', 1, 0.0, 100.0*periodForce, periodForce, '-factor', P)
pattern('Plain', 1, 1) 
load(2, 1.0) 
...
if testOK == 0:
    print("\nPASSED Verification Test sdofTransient.py \n\n")
else:
    print("\nFAILED Verification Test sdofTransient.py \n\n")
